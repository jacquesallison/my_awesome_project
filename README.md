...
- 🎯 Entry points to execute your program using `python -m <my_awesome_project>` or `$ my_awesome_project` with basic CLI argument parsing.
...
---
# my_awesome_project Flask Application

Awesome my_awesome_project created by jacquesallison
...
```bash
git clone https://github.com/jacquesallison/my_awesome_project my_awesome_project
...
```bash
my_awesome_project create-db   # run once
my_awesome_project populate-db  # run once (optional)
my_awesome_project add-user -u admin -p 1234  # ads a user
